...
- 2026-03-26: BosskuAI now has optional advisory hook-ready scripts under `ai-assistant/hooks/`. They must stay opt-in, stderr-only, and free of automatic memory or rule edits unless that posture is intentionally revisited.
