...
Open `../../references/playbooks/bosskuai-launch-commercialization-playbook.md` only when the task needs detailed framework choices, longer checklists, examples, or implementation depth.
