...
Open `../../references/playbooks/bosskuai-3d-web-development-playbook.md` only when the task needs detailed framework choices, longer checklists, examples, or implementation depth.
