...
Use this for marketing strategy, distribution, positioning, go-to-market planning, channels, messaging, growth loops, turning attention into adoption, and building executable social content calendars.
...
Open `../../references/playbooks/bosskuai-marketing-growth-playbook.md` only when the task needs detailed framework choices, longer checklists, examples, or implementation depth.
