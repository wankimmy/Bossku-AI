...
Use this to audit, maintain, and improve CLAUDE.md and Claude-specific rule files, including instruction quality, session learning capture, overlap control, and cross-tool consistency with BosskuAI memory.
...
Open `../../references/playbooks/bosskuai-claude-md-management-playbook.md` only when the task needs detailed framework choices, longer checklists, examples, or implementation depth.
