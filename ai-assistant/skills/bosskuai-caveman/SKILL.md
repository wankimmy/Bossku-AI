...
## bosskuAI integration

Caveman-compress skill available: compress always-loaded .md files to cut input tokens.
Run: `cd /path/to/caveman/caveman-compress && python3 -m scripts <filepath>`
