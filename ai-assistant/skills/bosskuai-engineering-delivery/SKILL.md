...
Open `../../references/playbooks/bosskuai-engineering-delivery-playbook.md` only when the task needs detailed framework choices, longer checklists, examples, or implementation depth.
