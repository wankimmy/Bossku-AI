...
Open `../../references/playbooks/bosskuai-gsap-animation-playbook.md` only when the task needs detailed framework choices, longer checklists, examples, or implementation depth.
