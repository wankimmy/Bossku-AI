# bosskuai-investor-prep Full Playbook
...
- `investor-prep-detailed-playbook.md` — extended step-by-step workflow and detailed templates that complement this playbook.
