# bosskuai-customer-discovery Full Playbook
...
- `customer-discovery-detailed-playbook.md` — extended step-by-step workflow and detailed templates that complement this playbook.
