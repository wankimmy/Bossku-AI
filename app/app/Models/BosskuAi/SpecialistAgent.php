...
class SpecialistAgent extends Model
{
    ...
    public function toOfficePayload(): array
    {
        return [
            ...
            'is_company_staff' => (bool) $this->is_company_staff,
            'staff_active' => (bool) $this->staff_active,
            'council_enabled' => (bool) $this->council_enabled,
            'runtime_mode' => $this->runtime_mode,
            'staff_sort_order' => (int) $this->staff_sort_order,
