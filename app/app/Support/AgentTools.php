...
class AgentTools
{
    ...
    protected static array $roleTools = [
        ...
        'designer' => ['file_read_safe', 'file_search', 'file_glob', 'file_edit', 'file_write_proposed', 'mcp_list_tools', 'mcp_call', 'log'],
        'executor' => ['file_read_safe', 'file_search', 'file_glob', 'file_edit', 'file_write_proposed', 'run_command', 'mcp_list_tools', 'mcp_call', 'log', 'db_query'],
