...
7. **Structured planner output**: include task understanding, success criteria, a checklist, expected artifacts, memory strategy, and a handoff message to executor.
