...
<template>
  <div class="mx-auto max-w-xl space-y-6">
    ...
    <form class="space-y-3" @submit.prevent="save">
      <div class="rounded-lg border border-zinc-200 bg-white p-3 text-sm dark:border-zinc-800 dark:bg-zinc-900">
        Model backend: <span class="font-medium">Ollama</span>
      </div>
