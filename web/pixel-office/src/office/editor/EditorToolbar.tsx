...
export function EditorToolbar({
  ...
  const laptopType = activeCategory === 'electronics' ? getDefaultLaptopType() : null
  const laptopEntry = laptopType ? getCatalogEntry(laptopType) : null
  const toolbarItems =
    laptopEntry && !categoryItems.some((e) => e.type === laptopEntry.type)
      ? [laptopEntry, ...categoryItems]
      : categoryItems
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 4, flexWrap: 'wrap' }}>
        ...
        <button
          ...
          title="Erase furniture or tiles"
        >
          Erase
        </button>
        <button
