...
import { canPlaceFurniture, resolveFurniturePlacement } from '../editor/editorActions.js'
      ...
      render: (ctx) => {
        ...
        if (isEditMode) {
          ...
          if (editorState.activeTool === EditTool.FURNITURE_PLACE && editorState.ghostCol >= 0) {
            ...
            if (entry) {
              const layout = officeState.getLayout()
              const { col: ghostCol, row: ghostRow } = resolveFurniturePlacement(
                layout,
            ...
            if (seatId) {
              ...
              if (seat && selectedCh) {
                if (selectedCh.seatId === seatId) {
                  ...
                  bossku.postMessage({ type: 'saveAgentSeats', seats })
                  return
                }
              }
            }
