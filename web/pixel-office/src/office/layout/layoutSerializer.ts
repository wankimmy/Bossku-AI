...
import { createRealisticOfficeLayout } from './realisticOfficeLayout.js'
...
/** Create the default office layout (zep realistic multi-room template). */
export function createDefaultLayout(): OfficeLayout {
  return createRealisticOfficeLayout()
}

/** Legacy two-room layout (hand-drawn furniture types). */
export function createLegacyDefaultLayout(): OfficeLayout {
