  ...
  return (
    <>
      ...
      >
        ...
        <button
          onClick={() => {
            bossku.postMessage({ type: 'openSessionsFolder' })
            onClose()
          }}
        ...
        <button
          onClick={() => {
            bossku.postMessage({ type: 'exportLayout' })
            onClose()
          }}
        ...
        <button
          onClick={() => {
            bossku.postMessage({ type: 'importLayout' })
            onClose()
          }}
        ...
        <button
          onClick={() => {
            ...
            bossku.postMessage({ type: 'setSoundEnabled', enabled: newVal })
          }}
