# bosskuai-browser-automation Full Playbook
...
- `browser-automation-detailed-playbook.md` — extended step-by-step workflow and detailed templates that complement this playbook.
