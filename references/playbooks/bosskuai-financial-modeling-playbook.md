# bosskuai-financial-modeling Full Playbook
...
- `financial-modeling-detailed-playbook.md` — extended step-by-step workflow and detailed templates that complement this playbook.
