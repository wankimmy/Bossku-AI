# bosskuai-design-systems Full Playbook
...
- `design-systems-detailed-playbook.md` — extended step-by-step workflow and detailed templates that complement this playbook.
