...
Open `../../references/playbooks/bosskuai-growth-experiment-playbook.md` only when the task needs detailed framework choices, longer checklists, examples, or implementation depth.
