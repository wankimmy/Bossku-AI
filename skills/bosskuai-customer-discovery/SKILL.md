...
Open `../../references/playbooks/bosskuai-customer-discovery-playbook.md` only when the task needs detailed framework choices, longer checklists, examples, or implementation depth.
