...
Open `../../references/playbooks/bosskuai-api-design-playbook.md` only when the task needs detailed framework choices, longer checklists, examples, or implementation depth.
