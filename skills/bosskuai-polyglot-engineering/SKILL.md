...
Use this for engineering guidance across programming languages, frameworks, runtimes, and ecosystem-specific tradeoffs rather than assuming one default stack.
...
Open `../../references/playbooks/bosskuai-polyglot-engineering-playbook.md` only when the task needs detailed framework choices, longer checklists, examples, or implementation depth.
