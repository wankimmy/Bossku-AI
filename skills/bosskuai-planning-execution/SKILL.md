...
Use this for roadmap planning, execution slicing, milestone sequencing, launch planning, prioritization, delivery coordination, ownership clarity, and keeping projects moving through to completion.
...
Open `../../references/playbooks/bosskuai-planning-execution-playbook.md` only when the task needs detailed framework choices, longer checklists, examples, or implementation depth.
