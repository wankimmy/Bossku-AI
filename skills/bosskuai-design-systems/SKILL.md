...
- `../../references/playbooks/design-systems-detailed-playbook.md`
...
- `../../references/playbooks/design-systems-detailed-playbook.md` — extended step-by-step workflow and detailed templates that complement this playbook.
